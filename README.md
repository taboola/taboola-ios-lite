...
### Version 1.4.16
- Adjust configuration parsing order.
- Added video specific configurations.

### Version 1.4.15
- Fixed incorrect scroll-to-top offset when Liquid Glass is enabled.
- Internal WebView logic improvements.
